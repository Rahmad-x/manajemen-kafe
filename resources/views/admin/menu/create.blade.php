<x-app-layout>
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 mt-0.5">Isi formulir di bawah ini untuk menambahkan varian menu kafe baru.</p>
        </div>
        ...
        <form action="{{ route('menus.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="nama_menu" name="nama_menu" value="{{ old('nama_menu') }}" placeholder="Contoh: Iced Caramel Latte" 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="status" class="block text-sm font-bold text-slate-700 mb-1">Status Awal</label>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="harga" name="harga" value="{{ old('harga') }}" placeholder="0" 
            ...
            <div class="pt-4 border-t border-gray-50 flex justify-end gap-2">
                <button type="reset" class="px-4 py-2 text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition">
                    Reset
                </button>
                <button type="submit" class="px-5 py-2 text-sm font-bold text-white bg-slate-900 hover:bg-slate-800 rounded-lg shadow-sm transition">
                    💾 Simpan Menu
                </button>
            </div>
        </form>
